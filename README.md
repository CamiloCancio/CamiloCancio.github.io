...
<html lang="es">
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum, minimum-scale=1.0">
        <title>Layout basica</title>
        ...
        <div class="contenedor">
            <header>
             ...
             <section class="main">
              ...
              <footer>
                <p>Camilo Cancio 2022 todos los derechos reservados</p>
              </footer>
        </div>
    </body>
</html>
